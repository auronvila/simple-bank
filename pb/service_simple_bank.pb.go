...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xb1\x03\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"W\x92A:\x12\vUpdate User\x1a+Used to partially update a user by username\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_userB\x85\x01\x92A]\x12[\n" +
	"\x0fSimple Bank API\"C\n" +
	"\n" +
	"Auron Vila\x12\x1chttps://github.com/auronvila\x1a\x17auronvila.dev@gmail.com2\x031.2Z#github.com/auronvila/simple-bank/pbb\x06proto3"
