...
// 	protoc        v5.29.3
// source: account/rpc_create_transfer.proto
...
func (x *CreateTransferRequest) Reset() {
	*x = CreateTransferRequest{}
	mi := &file_account_rpc_create_transfer_proto_msgTypes[0]
...
func (*CreateTransferRequest) Descriptor() ([]byte, []int) {
	return file_account_rpc_create_transfer_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateTransferResponse) Reset() {
	*x = CreateTransferResponse{}
	mi := &file_account_rpc_create_transfer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateTransferResponse) Descriptor() ([]byte, []int) {
	return file_account_rpc_create_transfer_proto_rawDescGZIP(), []int{1}
}
...
func (x *Transfer) Reset() {
	*x = Transfer{}
	mi := &file_account_rpc_create_transfer_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Transfer) Descriptor() ([]byte, []int) {
	return file_account_rpc_create_transfer_proto_rawDescGZIP(), []int{2}
}
...
func (x *Entry) Reset() {
	*x = Entry{}
	mi := &file_account_rpc_create_transfer_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Entry) Descriptor() ([]byte, []int) {
	return file_account_rpc_create_transfer_proto_rawDescGZIP(), []int{3}
}
...
var File_account_rpc_create_transfer_proto protoreflect.FileDescriptor

const file_account_rpc_create_transfer_proto_rawDesc = "" +
	"\n" +
	"!account/rpc_create_transfer.proto\x12\x02pb\x1a\x15account/account.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x97\x01\n" +
	...
	"\bcurrency\x18\x04 \x01(\tR\bcurrency\"\xee\x01\n" +
	...
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB-Z+github.com/auronvila/simple-bank/pb/accountb\x06proto3"

var (
	file_account_rpc_create_transfer_proto_rawDescOnce sync.Once
	file_account_rpc_create_transfer_proto_rawDescData []byte
)

func file_account_rpc_create_transfer_proto_rawDescGZIP() []byte {
	file_account_rpc_create_transfer_proto_rawDescOnce.Do(func() {
		file_account_rpc_create_transfer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_account_rpc_create_transfer_proto_rawDesc), len(file_account_rpc_create_transfer_proto_rawDesc)))
	})
	return file_account_rpc_create_transfer_proto_rawDescData
}

var file_account_rpc_create_transfer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_account_rpc_create_transfer_proto_goTypes = []any{
...
var file_account_rpc_create_transfer_proto_depIdxs = []int32{
	2, // 0: pb.CreateTransferResponse.transfer:type_name -> pb.Transfer
	4, // 1: pb.CreateTransferResponse.from_account:type_name -> pb.Account
	4, // 2: pb.CreateTransferResponse.to_account:type_name -> pb.Account
	3, // 3: pb.CreateTransferResponse.from_entry:type_name -> pb.Entry
	3, // 4: pb.CreateTransferResponse.to_entry:type_name -> pb.Entry
...
func init() { file_account_rpc_create_transfer_proto_init() }
func file_account_rpc_create_transfer_proto_init() {
	if File_account_rpc_create_transfer_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_account_rpc_create_transfer_proto_rawDesc), len(file_account_rpc_create_transfer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_account_rpc_create_transfer_proto_goTypes,
		DependencyIndexes: file_account_rpc_create_transfer_proto_depIdxs,
		MessageInfos:      file_account_rpc_create_transfer_proto_msgTypes,
	}.Build()
	File_account_rpc_create_transfer_proto = out.File
	file_account_rpc_create_transfer_proto_goTypes = nil
	file_account_rpc_create_transfer_proto_depIdxs = nil
}
