...
// UpdateAccountBasedOnUsername mocks base method.
func (m *MockStore) UpdateAccountBasedOnUsername(ctx context.Context, arg db.UpdateAccountBasedOnUsernameParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAccountBasedOnUsername", ctx, arg)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateAccountBasedOnUsername indicates an expected call of UpdateAccountBasedOnUsername.
func (mr *MockStoreMockRecorder) UpdateAccountBasedOnUsername(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAccountBasedOnUsername", reflect.TypeOf((*MockStore)(nil).UpdateAccountBasedOnUsername), ctx, arg)
}
